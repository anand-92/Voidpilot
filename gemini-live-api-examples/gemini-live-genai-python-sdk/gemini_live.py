    ...
    async def start_session(  # noqa: C901
        ...
        config = types.LiveConnectConfig(
            ...
            system_instruction=types.Content(
                parts=[
                    types.Part(
                        text="You are a helpful AI assistant. Keep your responses concise. Speak in a friendly Irish accent. You can see the user's camera or screen which is shared as realtime input images with you."  # noqa: E501
                    )
                ]
            ),
